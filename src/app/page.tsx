...
const COPY = {
  ru: {
    ...
    hero: {
      badge: "Юридическая защита женщин",
      title: "Adilet — твои права простым языком",
      subtitle:
        "Анонимная юридическая помощь и пошаговая защита прав женщин по законам Республики Казахстан: "Задать вопрос",
    },
    consultant: {
      ...
      examples: [
        ...
        "Что делать и куда обращаться в случае бытового насилия?",
